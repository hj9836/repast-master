package com.aaa.repast.admin.redis.config;

import com.aaa.repast.admin.redis.properties.RedisProperties;
...
public class RedisConfig {
    ...
    public JedisCluster getJedisCluster() {
        System.out.println("在RedisConfig中查看配置的节点信息"+redisProperties.getNodes());
